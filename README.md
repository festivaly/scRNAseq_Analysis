...
**注意**
以下のパイプラインで可能なのは10x Genomicsのデータのみであるので、確認する必要がある。ショートリード長が28bpであるものが基本的には対象である。またライブラリは確認する必要があり、v3以上が好ましい。ARCなどのATAC-seqがついているものも解析自体は可能であるが、少し工夫が必要であり、精度自体もあまりよくない
```bash
SRA_DIR=sra_dir
